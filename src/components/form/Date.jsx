...
const Date = ({ formik, name, label, yearsLimit, initialDate, className }) => {
    ...
    useEffect(() => {
        let now = jMoment(initialDate); // mitonim meghdar avaliye bedim behesh vagarna tarikh hamon roz ro dare va tarikh daryafti bayad be miladi bashe 
        setDay(now.jDate());
    ...
    return (
        <div className={`col-12 ${className} validate-input form_date_picker }`} >
