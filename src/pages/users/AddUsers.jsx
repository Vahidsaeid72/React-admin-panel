...
import { getSinglrUserService } from "../../services/users";
...
const AddUsers = () => {
  ...
  useEffect(() => {
    if (userToEdit) {
      ...
      setReInitialValues({
        birth_date: userToEdit.birth_date ? canvertDatetojalali(userToEdit.birth_date, 'jD / jM / jYYYY') : "",
        roles_id,
        password: "",
                ...
                return (
                  <Form className="row justify-content-center">
                    ...
                    <FormikControl
                      ...
                      name="birth_date"
                      label="تاریخ تولد"
                      initialDate={userToEdit?.birth_date ? userToEdit.birth_date : undefined}
